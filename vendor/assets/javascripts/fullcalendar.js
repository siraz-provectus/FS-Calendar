...
function AgendaEventRenderer() {
	...
	function slotSegHtml(event, seg) {
		...
		html +=
			...
			">" +
			"<div class='fc-event-inner' style="+"'" +skinCss+"'"+">" +
	...
	function buildHTMLForSegment(segment) {
		...
		html +=
			...
			" style=" +
				...
				"'" +
			">" +
			"<div class='fc-event-inner' style="+"'" +skinCss+"'"+">"; //Airat допилил чтобы цвет события отображался
		if (!event.allDay && segment.isStart) {												// почемуто он не работал
			html +=
